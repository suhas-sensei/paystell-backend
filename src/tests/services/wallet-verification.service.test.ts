...
describe('WalletVerificationService', () => {
    ...
    beforeEach(() => {
        ...
        (service as unknown as { walletVerificationRepo: MockRepository<WalletVerification> }).walletVerificationRepo = walletVerificationRepo;
        (service as unknown as { userRepo: MockRepository<User> }).userRepo = userRepo;
        (service as unknown as { emailService: jest.Mocked<EmailService> }).emailService = emailService;
    });
